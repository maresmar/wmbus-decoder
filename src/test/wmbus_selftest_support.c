...
const WmBusSelftestApatorPublicVector wmbus_selftest_apator_public_vectors[] = {
    {.id = "20202020",
     ...
     .telegram =
         "|6E4401062020202005077A9A006085||2F2F0F0A734393CC0000435B0183001A54E06F630291342510||030F00007B013E0B00003E0B00003E0B00003E0B00003E0B00003E0B00003E0B0000650000003D0000003D0000003D00000000000000A0910CB003FFFFFFFFFFFFFFFFFFFFA62B|"},
    {.id = "21202020",
     .total_m3_x1000 = 270133U,
     .parsed_len = 79U,
     .parsed_fnv1a = 0xE21779D0U,
     .telegram =
         "|4E4401062020202105077A13004085||2F2F0F6D4C389300020043840210||351F040075012C0B040048D603003E630300CD2C03001EF402000ACE0200A098A39603FFFFFFFFFFFFFFFFFFFFFFFFFF1977|"},
    {.id = "22202020",
     .total_m3_x1000 = 64508U,
     .parsed_len = 79U,
     .parsed_fnv1a = 0xEFC6CFE2U,
     .telegram =
         "|4E4401062020202205077A4B004085||2F2F0FE566B99390000087C0B24B732679FF75350010||FCFB00004155594265086A0043B4017301DFF600006AE70000BFD5000051BC0000A0F56C2602FFFF1B1B|"},
    {.id = "23202020",
     .total_m3_x1000 = 77752U,
     .parsed_len = 79U,
     .parsed_fnv1a = 0xA4B7D3F0U,
     .telegram =
         "|4E4401062020202305077A9D004085||2F2F0F81902C9300000010||B82F010041555942BD2882004319027301BC2601005C180100CB0A0100DFF60000A0F56C2602FFFFFFFFFFFFFFFFFFFFFFFFFF5B7C|"},
    {.id = "24202020",
     .total_m3_x1000 = 82426U,
     .parsed_len = 79U,
     .parsed_fnv1a = 0x31AF3493U,
     .telegram =
         "|4E4401062020202405077A6C0040852F2F||0F73B3E19410000084E15381E553810101000010||FA41010041555942BF4E8A00433B027301AD380100BC2601005C180100CB0A0100A0F56C2602FFFFD0D7|"},
    {.id = "25202020",
     .total_m3_x1000 = 168577U,
     .parsed_len = 79U,
     .parsed_fnv1a = 0x59DE9773U,
     .telegram =
         "|4E4401062020202505077AEF0040852F2F||0F|071122|94|100200|43|6103|84|8B745953486C09100000|10|81920200|75|01F1800200E5640200534A02003431020080150200D9000200||A0|DC939703|FFFFA434|"},
    {.id = "26202020",
     .total_m3_x1000 = 17579U,
     .parsed_len = 111U,
     .parsed_fnv1a = 0x1B33ED9FU,
     .telegram =
         "|6E4401062020202605077AAC0060852F2F||0F|0C4442|94|1A0000|43|B502|83|000A549B4159029C290F|10|AB440000|7B|012C440000BE3E00008838000072340000493000009B2C00001D2C0000822B00007428000010250000B7200000261C0000||A0|A4D9A103|FFFFFFFFFFFFFFFFFFFF7823|"},
    {.id = "26202020",
     .total_m3_x1000 = 17579U,
     .parsed_len = 111U,
     .parsed_fnv1a = 0xC36D9B9EU,
     .telegram =
         "|6E4401062020202605077AAD0060852F2F||0F|0E4442|94|1A0000|43|B502|84|4265594C655901010000|10|AB440000|7B|012C440000BE3E00008838000072340000493000009B2C00001D2C0000822B00007428000010250000B7200000261C0000||A0|A4D9A103|FFFFFFFFFFFFFFFFFFFF6C1B|"},
    {.id = "26202020",
     .total_m3_x1000 = 17579U,
     .parsed_len = 111U,
     .parsed_fnv1a = 0xE2911617U,
     .telegram =
         "|6E4401062020202605077AAE0060852F2F||0F|0F4442|94|1A0000|43|B502|81|D87F57D87F5701010000|10|AB440000|7B|012C440000BE3E00008838000072340000493000009B2C00001D2C0000822B00007428000010250000B7200000261C0000||A0|A4D9A103|FFFFFFFFFFFFFFFFFFFF5F22|"},
    {.id = "27202020",
     .total_m3_x1000 = 15992U,
     .parsed_len = 111U,
     .parsed_fnv1a = 0xAB31B2A9U,
     .telegram =
         "|6E4401062020202705077A3D0060852F2F||0F|151794|94|0A0200|43|0403|81|D87F57D87F5701010000|10|783E0000||7B01223C00009137000098320000392D000010290000F02600004C2400003422000004220000CB21000017200000C51C0000||A0|9AD9A103|FFFFFFFFFFFFFFFFFFFF367E|"},
    {.id = "03410514",
     .total_m3_x1000 = 30908U,
     .parsed_len = 63U,
     .parsed_fnv1a = 0x271F9CBAU,
     .telegram =
         "|3E4401061405410305077A190030852F2F||0F|86B4B8|95|290200|40|C6C1|B4|F0F3F3|41|5559|42|FA701000|F0|01010000|10|BC780000||FFFFFFFFFFFFFFFFFFFFFF2483|"},
    {.id = "03820304",
    ...
    {.id = "00148686",
     ...
     .telegram =
         "4E4401068686140005077A350040852F2F_0F005B599600000010AA55000041545A42850BD800437D037301C5500000564B00009E4600006A410000A01778EC03FFFFFFFFFFFFFFFFFFFFFFFFFFE393"},
    {.id = "04960212",
...
const char* wmbus_selftest_c_real_meter_capture_24008355_access_47 =
    ...
    "E7855830024242005FF44133B3A0000426C3F3C840113F5FD373C000082016C5E34D3013B240800C401EB02"
    "6D3B0D5B3267F6B1DC6210926A4ABD91371FB8BB24AD94849A7B78179A6A0B349D84FFB3DFE661631A7C2827"
    "DF058F6D0043BA4EBFEF4FEE34C460CBB2D3847F2A3CD5CF21DA0FA1345BC121F147C55621D17DBA52271A2FB"
    "FE7A62AA714713DF514213570D3F5A7EDF48D8642C391C74BE392F678D86FD2F05BE10EF8640359DEFC3DB792"
    "DF5BAB982DDDC765F01E8D61841C1F207F5D4065E742F270C1FF7B9185CFB3A3BE57FF3FAC";

const char* wmbus_selftest_c_real_meter_capture_24008355_access_48 =
    "54CD4E44243455830024050785DE7A480000202F2F041351710000046D1184738E5A3704FD17000000000"
    "E7855830024242005FF44133B3A0000426C3F3C840113F5FD373C000082016C5E34D3013B240800C401EB02"
    "6D3B0D5B3267F611EEB8B818ED6BFFF5EC502564F5F4CB32793A4CC65B9B063BC7A1968F793D645A7A666932AB"
    "CB524C7B3A56907E913588CF01A5A784F418D83B831FB1FA501C51AD6E63C2283327448819D51D9B95273B43A3"
    "F0F42DC835D7B6975BF9C668DEB3FE92EDD1A6490139D22F27E1F2D3C363DF43BB6E28FF062F205BB8A228D41"
    "FFEAFDDB36383E2402F98BF0C3C3259A77D1E01356B5ACC874F0563B4A737ACB6648E43";
